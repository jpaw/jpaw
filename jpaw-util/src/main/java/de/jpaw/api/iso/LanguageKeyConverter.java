...
public final class LanguageKeyConverter {
    private static final int OFFSET_COMPUTED_2 = 60;                // offset for 2 letter codes
    private static final int OFFSET_COMPUTED_5 = 60 + 32 * 32;      // offset for 5 letter codes
